...
function main() {
  ...
  const partnerNames = ['Emma', 'Perla', 'Olivia', 'Sarah', 'Ava'];
  const locations = ['New York', 'London', 'Paris', 'Netherlands', 'Sydney'];
  const jobTitles = ['doctor', 'teacher', 'engineer', 'artist', 'chef'];
